...
export const speciesLogros = async (req, res, next) => {
  ...
  const condicionesLogros = {
    ...
    'Ojo Agudo': () => usuario.especiesVisionadas >= 4, // Si el usuario ha visto 15 especies
    'Eco Explorador': () => usuario.especiesVisionadas >= 7, // Si el usuario ha visto 30 especies
  };
